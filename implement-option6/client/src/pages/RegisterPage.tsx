...
export default function RegisterPage() {
  ...
  const [role, setRole] = useState<"coordinator" | "respondent">("respondent");
      ...
      <form onSubmit={handleSubmit} className="space-y-4 mt-4">
        ...
        <div>
          ...
          <select
            ...
            value={role}
            onChange={(e) =>
              setRole(e.target.value as "coordinator" | "respondent")
            }
            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
          >
            <option value="respondent">Survey Respondent</option>
            <option value="coordinator">Survey Coordinator</option>
          </select>
        </div>
